...
SYSTEM = (
    ...
    "  - FULL CONTROL is granted. Creating/deleting tracks, loading instruments,\n"
    "    drum kits and effects, renaming and moving tracks are all ALLOWED.\n"
    "    The old template-protection ban was lifted by the user on 2026-08-27.\n"
    "  - Destructive ops (delete_clip, delete/replace a track, overwriting a rack)\n"
    "    still get ONE plain-language confirmation first, then proceed.\n"
    "  - Find tracks BY NAME. Iterate get_track_info until name matches, then use that\n"
    "    index. Indices shift between sessions.\n"
    "  - Whole song is in scope, any track, group, return or master.\n"
